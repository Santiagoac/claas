    ...
    <Container className="pb-44 pt-20 text-center lg:pt-32">
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-800 sm:text-7xl">
        ...
        <span className="relative whitespace-nowrap text-cyan-600">
          ...
          <span className="relative">Ofrece crédito</span>
        </span>{' '}
        a tus clientes
      </h1>
      <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-500">
        Transforma tus <span className="text-slate-500"><b>contratos comerciales</b></span> en <b><span className="text-teal-600">contratos de crédito</span></b>
      </p>
      <div className="mt-10 flex justify-center gap-x-6">
        <Button href="https://calendar.app.google/FbmW7JQbkYsB86Mm8" color="sky">
          <span>
            Agendar una llamada
          </span>  
        </Button>
